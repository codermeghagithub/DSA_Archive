...
public class Add_2d_arr
{
    static void Display_Matrix(int[][] sum){
        System.out.print("2Dd arr print:");
...
// r1 = 3;   // initialized
    ...
    static void Addition(int[][]arr,int r1,int c1,int[][]arr2,int r2,int c2){
    if(r1!=r2 || c1!=c2){
	...
	Scanner sc = new Scanner(System.in);
       ...
       System.out.print("Enter the ele of arr:") ;  
        for(int i=0;i<r1;i++){
            for(int j=0;j<c1;j++){
                arr[i][j]=sc.nextInt();
                         }}
